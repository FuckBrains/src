...
if __name__ == '__main__':
    ...
    country = 'us'
    ip = '46.4.174.10'    
    super_proxy_url = 'customer-%s-cc-%s-sesstime-30:%s@%s:7777'%(username, country, password,ip)  
    # port = 7777
    path = r'driver/chromedriver_'+str(80)+'.exe'
    options.add_extension(get_chrome_proxy_extension(proxy=super_proxy_url))
