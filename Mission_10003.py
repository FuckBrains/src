...
import sys
sys.path.append("..")
# from modules_add.email_module.imap import email_imap as imap
# import json
import re
...
def web_submit(submit):
    ...
    while True:
        if 'Looking for sex tonight in your area?' in chrome_driver.page_source:
            chrome_driver.find_element_by_xpath('//*[@id="home"]/div[7]/div[2]/div/div[3]/a[2]').click()
            chrome_driver.find_element_by_xpath('//*[@id="home"]/div[7]/div[2]/div/div[4]/a[1]').click()
            chrome_driver.find_element_by_xpath('//*[@id="home"]/div[7]/div[2]/div/div[5]/a[1]').click()
            chrome_driver.find_element_by_xpath('//*[@id="home"]/div[7]/div[2]/div/div[6]/a[1]').click()
            chrome_driver.find_element_by_xpath('//*[@id="home"]/div[7]/div[2]/div/div[7]/a').click()
        else:
            chrome_driver.refresh()
            continue
        if 'swipesecrets.com' in chrome_driver.current_url:
            break
        else:
            chrome_driver.get(submit['Site'])
