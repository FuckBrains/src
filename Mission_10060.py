...
def web_submit(submit,chrome_driver,debug=0):
    ...
    # accept
    try:
        chrome_driver.find_element_by_xpath('/html/body/div[1]/section/div/div[3]/div[1]/div[2]/div[2]').click()
    except:
        pass
    # selector
    index = random.randint(1,3)
    element = '//*[@id="orientation-field"]'
    s1 = Select(chrome_driver.find_element_by_xpath(element))
    s1.select_by_index(index)  
    # next
    chrome_driver.find_element_by_xpath('//*[@id="reg-form"]/div/div[3]/span').click()  
    # age
    element = '//*[@id="age-field"]'
