...
if __name__=='__main__':
    ...
    print(submit)
    web_submit(submit,1)
    # submit = {'Email': {'Email_Id': '6f89149b-aa34-11e9-aecd-0003b7e49bfc', 'Email_emu': 'NellieHopkinsSJ@aol.com', 'Email_emu_pwd': 'XGWzJOo5', 'Email_assist': '', 'Email_assist_pwd': '', 'Status': None}}
